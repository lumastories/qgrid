...
var _user$project$Main$initModel = {content: 'Hello!', matrixs: _krisajenkins$remotedata$RemoteData$NotAsked};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {content: a, matrixs: b};
	});
var _user$project$Main$Matrix = F4(
	function (a, b, c, d) {
		return {name: a, grid: b, row_names: c, col_names: d};
	});
var _user$project$Main$decodeMatrix = _elm_lang$core$Json_Decode$list(
	A5(
		_elm_lang$core$Json_Decode$map4,
		_user$project$Main$Matrix,
...
var _user$project$Main$getMatrixs = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Main$MatrixsResp,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, '/api/matrix', _user$project$Main$decodeMatrix)));
var _user$project$Main$model = {
	...
	_1: _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _user$project$Main$getMatrixs,
			_1: {ctor: '[]'}
		})
};
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Main$model, view: _user$project$Main$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions})();
var _user$project$Main$Reset = {ctor: 'Reset'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"Main.Msg":{"args":[],"tags":{"MatrixsResp":["RemoteData.WebData (List Main.Matrix)"],"Reset":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}}},"aliases":{"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.Matrix":{"args":[],"type":"{ name : String , grid : List (List String) , row_names : List String , col_names : List String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
